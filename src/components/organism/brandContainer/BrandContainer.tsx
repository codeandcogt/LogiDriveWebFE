...
export const BrandContainer: React.FC = () => {
  return (
    <div className="hidden md:flex w-full md:w-1/2 h-full justify-center items-center bg-gradient-to-r from-orange-400 to-rose-400 rounded-2xl shadow-2xl p-8">
