...
import { ModalProfile } from "@/components/molecule";
  ...
  return (
    <>
            ...
            <div className="flex gap-1">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    {unreadCount > 0 && (
                      <Badge className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center bg-red-500 text-white rounded-full">
                        {unreadCount}
                      </Badge>
                    )}
                  </Button>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => setModalProfile(true)}>
      ...
      <ModalProfile
        ...
        description="Revise la información del perfil"
        open={modalProfile}
        onOpenChange={setModalProfile}
        onConfirm={() => {
